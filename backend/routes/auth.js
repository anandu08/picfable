...
router.post(
  ...
  async (req, res) => {
    ...
    try {
      ...
      if(temp==authtoken) res.redirect("https://picfable.onrender.com/app");
      else res.redirect("https://picfable.onrender.com/user");
    } catch (error) {
  ...
  async (req, res) => {
    ...
    try {
      ...
      if (pass) {
        ...
        res.redirect("https://picfable.onrender.com/app");
      } else {
